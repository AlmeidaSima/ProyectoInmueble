...
INSERT INTO `contrato_alquiler` VALUES (1,1,'2025-01-24','2025-01-29',150000.00);
...
CREATE TABLE `recibo_pago` (
  ...
  `RecMonto` decimal(10,2) NOT NULL,
  `RecDscto` decimal(10,2) DEFAULT '0.00',
  `RecMan` decimal(10,2) DEFAULT '0.00',
  `RecTotal` decimal(10,2) NOT NULL,
  PRIMARY KEY (`idRecibo`),
  KEY `idPago` (`idPago`),
  CONSTRAINT `recibo_pago_ibfk_1` FOREIGN KEY (`idPago`) REFERENCES `contrato_alquiler` (`idAlquiler`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-01-20  3:49:34
